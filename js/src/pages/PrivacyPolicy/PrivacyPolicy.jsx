...
const PrivacyPolicyContent = () => (
  <Fragment>
    ...
    <p>
      ...
      , the submitted data about your battery percentage, charger status,
      timestamp, and name will be collected.
    </p>

    <p>
      This privacy policy is subject to change without notice and was last
      updated on November 20, 2018. If you have any questions feel free to
      contact us directly here: electrics@fortheusers.org.
    </p>
  </Fragment>
);
